        ...
        while ($result = mysqli_fetch_assoc($query)) {
          ...
          <tr>
            ...
            <td class="d-flex"> <span>
              ...
              <span><a href="edit_emp.php?id=<?= $result['id'] ?>"><i
                    class="bi bi-pencil-square text-primary mx-1"></i></a></span>
              <form action="" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                <input type="hidden" name="user_id" value="<?= $result['id'] ?>">
                <button class="p-0 border-0 bg-light" name="User_delete"><i
                    class="bi bi-trash3-fill text-danger mx-1"></i></button>
              </form>
            </td>
          </tr>
        <?php }
